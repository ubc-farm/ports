import {
	...
	addCssText, removeCssText
} from '../../util.js'
import {
	stack, nostack,
	orderByStart, orderByEnd
} from '../Stack.js';
...
export default class Group {
	...
	_updateVisibleItems(orderedItems, oldVisibleItems, range) {
		...
		this._traceVisible(initialPosByStart, orderedItems.byStart, visibleItems, visibleItemsLookup, 
		...
		if (this.checkRangedItems == true) {
			...
			this._traceVisible(initialPosByEnd, orderedItems.byEnd, visibleItems, visibleItemsLookup, 
				item => item.data.end < lowerBound || item.data.end > upperBound);
		}
